...
@Component({
  selector: 'app-transaction-service-anjing',
  templateUrl: './transaction-service-anjing.page.html',
  styleUrls: ['./transaction-service-anjing.page.scss'],
})
export class TransactionServiceAnjingPage implements OnInit {
